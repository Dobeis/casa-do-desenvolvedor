<template>
  <div>
    <header-comp titulo="Soluções fiscais para softwares de"
                 subtitulo="O ramo de prestação de serviços foi agraciado com o documento fiscal eltetrônico mais complexo. Não há um padrão nacional. Aliás, há sim: o nosso."
                 squad="Serviços" 
                 cor="#61D0F7" 
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="title op-8">Bem-vindo ao Squad Serviços da Casa do Desenvolvedor</h2>
                    <h6 class="subtitle">Aqui você encontra tudo que precisa para o módulo fiscal do seu software. Na área de serviços, há apenas um documento fiscal: a Nota Fiscal de Serviços Eletrônica. Mas não se engane: a NFS-e, sozinha, pode te dar uma enorme dor de cabeça.</h6>
                </div>
            </div>
            <!-- Row  -->
                    ...
                    <ul class="nav vtab f41-tab">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-expanded="true">
                                <div class="display-5 t-icon t-servicos"><i class="icon-apartments"></i></div>
                                <div>
                                    <h5 class="m-b-0">NFSe</h5>
                                    <h6 class="subtitle">Centenas de prefeituras. <br>Um só layout.</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
...
.wrap-feature41-box .f41-tab li a.active .t-servicos, .wrap-feature41-box .f41-tab li a:hover .t-servicos {
  background: #61D0F7;
  background: -webkit-linear-gradient(legacy-direction(to right), #61D0F7 0%, #27AAE1 100%);
  background: -webkit-gradient(linear, left top, right top, from(#61D0F7), to(#27AAE1));
